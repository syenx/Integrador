    ...
    public abstract class SessionManager
    {
        ...
        private void InitSessionFactory()
        {
            ...
            configuration.DataBaseIntegration(c =>
            {
                ...
                c.ConnectionString = TecnoStr.ConnTec.decryptStr(System.Configuration.ConfigurationManager.ConnectionStrings["ProIntegracao.Local"].ConnectionString.ToString());
                c.KeywordsAutoImport = Hbm2DDLKeyWords.AutoQuote;
            }).AddMapping(mapeamentoDominio);

            configuration.AddAssembly("ProIntegracao.API");
